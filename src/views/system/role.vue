    ...
    <div class="role">
        ...
        <div class="table-container">
            <el-card class="box-card">
                ...
                <el-pagination @size-change="handleSizeChange" @current-change="handleCurrentChange" :current-page.sync="filters.page" :page-sizes="[20, 100, 500, 1000]" :page-size="filters.per_page" layout="total, sizes, prev, pager, next, jumper" :total="total">
                </el-pagination>
            </el-card>
        </div>
        ...
        <div class="editor-container">
            <el-dialog :title="editorStatus == 1 ? '新增' : '编辑'" :visible.sync="editorVisible">
                <el-form :model="editor" :rules="editorRules" ref="editor" label-width="120px">
                    ...
                    <el-form-item label="备注" prop="remark">
                        <el-input type="textarea" placeholder="请输入内容" v-model.trim="editor.remark"></el-input>
                    </el-form-item>
                </el-form>
            ...
            <el-dialog title="权限设置" :visible.sync="menuVisible">
                <el-tree ref="tree" :data="menuList" show-checkbox node-key="id" :props="menuProps" :default-expand-all="true">
                </el-tree>
